...
public class SetChargingProfileResponseHandler implements IMessageHandler<Message> {

    private final Logger logger = Logger.getLogger(getClass().getName());
    private final OCPPMessageToSubjectMapping.OCPPMessageType ocppMessageType =
            OCPPMessageToSubjectMapping.OCPPMessageType.SetChargingProfileResponse;
    ...
    public void onMessageReceived(String subject, Message msg, Object connection) {
        try {
            SetChargingProfileResponse setChargingProfileResponse = SetChargingProfileResponse.parseFrom(msg.getData());
