...
public class SetChargingProfileRequestHandler implements IMessageHandler<Message> {
    ...
    public void onMessageReceived(String subject, Message msg, Object connection) {
        try {
            ...
            SetChargingProfileRequest.Builder msgBuilder = SetChargingProfileRequest.newBuilder();
            JsonFormat.parser().ignoringUnknownFields().merge(jsonPayload, msgBuilder);

            SetChargingProfileRequest setChargingProfileRequest = msgBuilder.build();
