...
public class CallMessageImpl<T> implements ICallMessage<T> {
    private final T payload;
    private final String action;
    private final String messageId;

    public CallMessageImpl(T payload, String action, String messageId) {
    ...
    public static class CallMessageBuilder<T> {
        ...
        public ICallMessage<T> build() {
            ...
            return new CallMessageImpl<>(payload, action, messageId);
        }
    }
}
