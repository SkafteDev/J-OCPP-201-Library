package dk.sdu.mmmi.digitalenergyhub.ocpp2_0_1.unit.rpcframework.serialization.callerrormessage;
...
public class ICallErrorDeserializerTest {
    ...
    void unit_serialize_CallErrorMessage_NOT_IMPLEMENTED_empty_error_details() {
        try {
            ...
            ICallError actual = (ICallError) CallResultMessageDeserializer.deserialize(json, Object.class);
    ...
    void unit_serialize_CallErrorMessage_invalid_error_details() {
            ...
            assertThrows(JsonProcessingException.class,
                    () -> CallResultMessageDeserializer.deserialize(json, Object.class));
    }
}
