...
public class BootNotificationRequestDeserializerTest {
    ...
    void unit_deserialize_serialize_roundtrip_CallMessage_of_type_BootNotificationRequest() {
        ...
        try {
            ICallMessage<BootNotificationRequest> deserialized = CallMessageDeserializer.deserialize(jsonInput, BootNotificationRequest.class);
            String serialized = CallMessageSerializer.serialize(deserialized);
