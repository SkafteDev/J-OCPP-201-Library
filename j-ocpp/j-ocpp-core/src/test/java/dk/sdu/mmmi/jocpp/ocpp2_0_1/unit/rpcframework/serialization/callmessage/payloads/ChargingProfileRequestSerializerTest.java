...
public class ChargingProfileRequestSerializerTest {

    @Test
    void unit_chargingProfile_serializer_test() {
        ChargingProfile chargingProfile = ChargingProfile.builder()
                .withId(1)
                .withStackLevel(0)
                ...
                .withChargingSchedule(
                        List.of(
                                ChargingSchedule.builder()
                                        .withId(1)
                                        .withStartSchedule(ZonedDateTime.of(2024, 1, 20, 0, 0, 0, 0, ZoneId.of("Z")))
