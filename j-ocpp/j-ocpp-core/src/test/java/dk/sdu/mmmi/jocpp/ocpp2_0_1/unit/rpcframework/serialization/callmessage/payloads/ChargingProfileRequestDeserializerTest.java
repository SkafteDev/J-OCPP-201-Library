...
public class ChargingProfileRequestDeserializerTest {
    ...
    void unit_chargingProfile_deserializer_test() {
        ...
        ICall<SetChargingProfileRequest> expected = CallImpl.<SetChargingProfileRequest>newBuilder()
        ...
        try {
            ...
            ICall<SetChargingProfileRequest> actual = CallDeserializer.deserialize(jsonCall, SetChargingProfileRequest.class);
